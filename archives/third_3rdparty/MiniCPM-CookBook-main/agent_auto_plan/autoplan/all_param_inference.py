"""本文件是用来测试模型推理的文件 This file is used to test model inference"""
...
if __name__ == "__main__":
    ...
    # question = "Có những phương pháp nào để xác định mức độ an toàn của trực thăng khi bay trong vùng hỏa lực phòng không của đối phương?"
