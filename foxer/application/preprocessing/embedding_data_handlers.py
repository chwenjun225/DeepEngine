...
from foxer.application.networks import EmbeddingModelSingleton
from foxer.domain.chunks import ArticleChunk, Chunk, PostChunk, RepositoryChunk
from foxer.domain.embedded_chunks import (
    EmbeddedArticleChunk,
    EmbeddedChunk,
    EmbeddedPostChunk,
    EmbeddedRepositoryChunk,
)
from foxer.domain.queries import EmbeddedQuery, Query
