...
from foxer.application.networks.embeddings import EmbeddingModelSingleton
from foxer.domain.exceptions import ImproperlyConfigured
from foxer.domain.types import DataCategory
from foxer.infrastructure.db.qdrant import connection
